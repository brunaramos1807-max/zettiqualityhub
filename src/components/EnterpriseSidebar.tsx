...
import { LayoutDashboard, TrendingUp, RefreshCw, ClipboardCheck, Upload, AlertTriangle, History, FileText, Settings, ChevronLeft, ChevronRight, LogOut, Activity, Zap, Users, ChevronDown, ScrollText,  } from 'lucide-react';
...
function getActiveSection(pathname: string): string {
  if (
    pathname === '/' || pathname.startsWith('/evolucao-geral') ||
