      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: '#94A3B8' }}>
          ...
          >
            ...
            <p>
              Ao acessar e utilizar a plataforma QUALIVISÃO, você concorda com estes Termos de Uso.
          ...
          >
            ...
            <p>
              A QUALIVISÃO é uma plataforma enterprise de gestão da qualidade operacional,
              fornecendo dashboards executivos, indicadores estratégicos e ferramentas de
              inteligência gerencial para tomada de decisão.
            </p>
          </section>
          ...
          >
            ...
            <p>
              A plataforma é de uso exclusivo para colaboradores e gestores autorizados pela
              organização. É proibido:
            </p>
          ...
          >
            ...
            <p>
              ...
              por todas as atividades realizadas em sua conta. Qualquer uso não autorizado deve ser
              reportado imediatamente ao administrador do sistema.
            </p>
          </section>
          ...
          >
            ...
            <p>
              Todo o conteúdo, design e funcionalidades da plataforma QUALIVISÃO são propriedade da
              organização e estão protegidos por direitos autorais. É proibida a reprodução ou
          ...
          >
            ...
            <p>
              A plataforma é fornecida "como está". Não garantimos disponibilidade ininterrupta do
              serviço. Não nos responsabilizamos por perdas decorrentes de uso indevido da
              plataforma.
            </p>
          </section>
          ...
          >
            ...
            <p>
              ...
              <span style={{ color: '#38BDF8' }}>suporte@qualivisao.tec.br</span>
            </p>
          </section>
        </div>
      </div>
