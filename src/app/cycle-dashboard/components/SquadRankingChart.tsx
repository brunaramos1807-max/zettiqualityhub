...
const SquadRankingChartInner = dynamic(
  () => import('./SquadRankingChartInner'),
  { ssr: false, loading: () => <div className="h-64 animate-pulse rounded-lg" style={{ backgroundColor: '#1C2333' }} /> }
);
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs mt-0.5" style={{ color: '#8B949E' }}>QA Média e IEPC por squad — meta fixada em 85</p>
        </div>
      ...
      {data.length === 0 ? (
        <div className="h-48 flex items-center justify-center">
          <p className="text-sm" style={{ color: '#8B949E' }}>Nenhum dado disponível</p>
        </div>
      ) : (
