        ...
        >
          <div className="flex items-start gap-4">
            <div
              ...
              style={{
                backgroundColor:
                  pillarInfo.type === 'QA' ? 'rgba(43,79,129,0.2)' : 'rgba(234,179,8,0.15)',
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span
                  className={`text-xs font-semibold px-2 py-0.5 rounded-full ${pillarInfo.type === 'QA' ? 'badge-warning' : 'badge-success'}`}
                >
                  {pillarInfo.type}
                </span>
                <span className="text-xs" style={{ color: '#8B949E' }}>
                  Máx. {pillarInfo.maxPoints} pts
                </span>
              </div>
