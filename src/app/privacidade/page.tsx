      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: '#94A3B8' }}>
          ...
          >
            ...
            <p>
              A QUALIVISÃO coleta informações necessárias para o funcionamento da plataforma
              enterprise de gestão da qualidade operacional. Isso inclui dados de autenticação
              (e-mail, nome) fornecidos via Google OAuth, dados de uso da plataforma e informações
              inseridas pelos usuários no sistema.
            </p>
          </section>
          ...
          >
            ...
            <p>
              ...
              para o funcionamento dos serviços integrados (Supabase para banco de dados, Google
              para autenticação) ou quando exigido por lei.
            </p>
          </section>
          ...
          >
            ...
            <p>
              ...
              informações contra acesso não autorizado, alteração, divulgação ou destruição. O
              acesso à plataforma é protegido por autenticação OAuth 2.0 via Google.
            </p>
          </section>
          ...
          >
            ...
            <p>
              ...
              pessoais. Para exercer esses direitos, entre em contato conosco através do suporte.
            </p>
          </section>
