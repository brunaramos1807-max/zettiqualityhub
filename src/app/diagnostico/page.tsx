...
import { GitBranch, CheckCircle2, ArrowRight, Plus, AlertCircle, Calendar, RefreshCw, X,  } from 'lucide-react';
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <span
                          className={`text-[10px] font-bold px-1.5 py-0.5 rounded uppercase ${
                            inv.status === 'causa_validada' ?'bg-emerald-50 text-emerald-700 border border-emerald-200'
                              : inv.status === 'convertida_plano' ?'bg-blue-50 text-blue-700 border border-blue-200' :'bg-amber-50 text-amber-700 border border-amber-200'
                          }`}
                        >
                  ...
                  <div className="flex gap-2 pt-3">
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs font-bold rounded-md transition-colors ${
                        abaAtiva === 'ishikawa' ?'bg-purple-700 text-white' :'bg-slate-100 text-slate-600 hover:bg-slate-200'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs font-bold rounded-md transition-colors ${
                        abaAtiva === '5porques' ?'bg-purple-700 text-white' :'bg-slate-100 text-slate-600 hover:bg-slate-200'
                      }`}
                    >
