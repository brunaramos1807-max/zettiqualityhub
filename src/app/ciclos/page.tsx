...
import { RefreshCw, Lock, Unlock, Calendar, Plus, ShieldCheck, X, Edit3,  } from 'lucide-react';
                          ...
                          <span
                            className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold uppercase ${
                              c.status === 'fechado_homologado'
                                ...
                                : c.status === 'em_validacao' ?'bg-purple-50 text-purple-700 border border-purple-200'
                                  : c.status === 'em_apuracao' ?'bg-blue-50 text-blue-700 border border-blue-200' :'bg-amber-50 text-amber-700 border border-amber-200'
                            }`}
                          >
                            {c.status.replace('_', ' ')}
                          </span>
