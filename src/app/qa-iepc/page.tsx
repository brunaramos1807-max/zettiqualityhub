...
const QA_PILLARS = [
  {
    key: 'p1',
    label: 'P1 Fluxo',
    fullName: 'P1 — Gestão do Fluxo e Rastreabilidade do Atendimento',
    color: '#3B82F6',
    max: 22,
    desc: 'Avalia identificação, protocolo SUP, rastreabilidade e encerramento do atendimento.',
  },
  {
    key: 'p2',
    label: 'P2 Tratativa',
    fullName: 'P2 — Gestão da Tratativa da Demanda',
    color: '#06B6D4',
    max: 34,
    desc: 'Avalia validação de dúvidas, orientação, resolução ou direcionamento e documentação técnica.',
  },
  {
    key: 'p3',
    label: 'P3 Análise',
    fullName: 'P3 — Análise e Assertividade Técnica da Demanda',
    color: '#10B981',
    max: 18,
    desc: 'Avalia análise técnica da demanda e uso adequado das ferramentas de apoio.',
  },
  {
    key: 'p4',
    label: 'P4 Comunicação',
    fullName: 'P4 — Qualidade da Comunicação no Atendimento',
    color: '#F59E0B',
    max: 14,
    desc: 'Avalia uso da língua portuguesa, tom profissional e clareza da comunicação.',
  },
  {
    key: 'p5',
    label: 'P5 Conduta',
    fullName: 'P5 — Conduta Relacional no Atendimento',
    color: '#8B5CF6',
    max: 12,
    desc: 'Avalia cordialidade, empatia, proatividade e over delivery.',
  },
];
...
const IEPC_DIMS = [
  {
    ...
    color: '#38BDF8',
    max: 30,
    desc: 'Percepção do cliente sobre a resolução efetiva do problema.',
  },
  {
    key: 'e2',
    label: 'E2 Clareza',
    fullName: 'E2 — Compreensão e Segurança (Clareza/Confiança)',
    color: '#A855F7',
    max: 20,
    desc: 'Clareza das informações transmitidas e confiança gerada no cliente.',
  },
  {
    key: 'e3',
    label: 'E3 Esforço',
    ...
    color: '#10B981',
    max: 20,
    desc: 'Nível de esforço exigido do cliente para resolver sua demanda.',
  },
  {
    key: 'e4',
    label: 'E4 Tempo',
    ...
    color: '#F59E0B',
    max: 15,
    desc: 'Percepção de agilidade e fluidez no atendimento.',
  },
  {
    key: 'e5',
    label: 'E5 Relacional',
    ...
    color: '#F97316',
    max: 15,
    desc: 'Qualidade da relação humana e experiência emocional do cliente.',
  },
];
...
const SUBPILARES = [
  {
    ...
    items: [
      {
        id: '1.1',
        label: 'Identificação e Boas-vindas',
        max: 5,
        desc: 'Avalia se o analista se identificou corretamente e realizou boas-vindas ao cliente conforme protocolo.',
        objetivo: 'Garantir abertura profissional e rastreável do atendimento.',
      },
      {
        id: '1.2',
        label: 'Formalização e comunicação do protocolo SUP',
        max: 9,
        desc: 'Avalia se o protocolo SUP foi registrado e comunicado ao cliente de forma adequada.',
        objetivo: 'Assegurar rastreabilidade e formalização do atendimento.',
      },
      {
        id: '1.3',
        label: 'Encerramento da interação por etapa',
        max: 8,
        desc: 'Avalia se o encerramento de cada etapa foi realizado corretamente com confirmação do cliente.',
        objetivo: 'Garantir conclusão formal e satisfatória de cada etapa.',
      },
    ],
  },
  {
    ...
    items: [
      {
        id: '2.1',
        label: 'Validação e esclarecimento de dúvidas',
        max: 8,
        desc: 'Avalia se o analista validou e esclareceu todas as dúvidas do cliente de forma completa.',
        objetivo: 'Garantir compreensão mútua e alinhamento de expectativas.',
      },
      {
        id: '2.2',
        label: 'Orientação e condução da execução',
        max: 9,
        desc: 'Avalia a qualidade da orientação fornecida e condução do processo de execução.',
        objetivo: 'Assegurar que o cliente seja guiado com clareza e segurança.',
      },
      {
        id: '2.3',
        label: 'Resolução ou direcionamento adequado',
        max: 9,
        desc: 'Avalia se a demanda foi resolvida ou direcionada corretamente ao setor competente.',
        objetivo: 'Garantir resolução efetiva ou encaminhamento assertivo.',
      },
      {
        id: '2.4',
        label: 'Documentação técnica do atendimento',
        max: 8,
        desc: 'Avalia a qualidade e completude do registro técnico do atendimento no sistema.',
        objetivo: 'Manter histórico técnico preciso e rastreável.',
      },
    ],
  },
  {
    ...
    items: [
      {
        id: '3.1',
        label: 'Análise técnica da demanda',
        max: 10,
        desc: 'Avalia a profundidade e assertividade da análise técnica realizada pelo analista.',
        objetivo: 'Garantir diagnóstico correto e solução tecnicamente adequada.',
      },
      {
        id: '3.2',
        label: 'Uso adequado das ferramentas de apoio',
        max: 8,
        desc: 'Avalia se as ferramentas de apoio foram utilizadas de forma correta e eficiente.',
        objetivo: 'Maximizar eficiência e qualidade técnica do atendimento.',
      },
    ],
  },
  {
    ...
    items: [
      {
        id: '4.1',
        label: 'Uso adequado da língua portuguesa',
        max: 4,
        desc: 'Avalia gramática, ortografia e uso correto da língua portuguesa na comunicação.',
        objetivo: 'Garantir comunicação clara, profissional e sem erros linguísticos.',
      },
      {
        id: '4.2',
        label: 'Adequação do tom e postura profissional',
        max: 5,
        desc: 'Avalia se o tom utilizado foi adequado ao contexto e manteve postura profissional.',
        objetivo: 'Assegurar comunicação respeitosa e alinhada ao padrão da empresa.',
      },
      {
        id: '4.3',
        label: 'Clareza e organização da comunicação',
        max: 5,
        desc: 'Avalia se a comunicação foi clara, organizada e de fácil compreensão para o cliente.',
        objetivo: 'Garantir que o cliente compreenda todas as informações transmitidas.',
      },
    ],
  },
  {
    ...
    items: [
      {
        id: '5.1',
        label: 'Cordialidade e empatia',
        max: 4,
        desc: 'Avalia o nível de cordialidade e empatia demonstrado durante o atendimento.',
        objetivo: 'Criar experiência positiva e humanizada para o cliente.',
      },
      {
        id: '5.2',
        label: 'Proatividade na condução',
        max: 5,
        desc: 'Avalia se o analista foi proativo em antecipar necessidades e conduzir o atendimento.',
        objetivo: 'Superar expectativas e reduzir esforço do cliente.',
      },
      {
        id: '5.3',
        label: 'Over delivery',
        max: 3,
        desc: 'Avalia se o analista entregou além do esperado, surpreendendo positivamente o cliente.',
        objetivo: 'Gerar encantamento e fidelização do cliente.',
      },
    ],
  },
];
...
function SubpilarTooltip({ item, pillarName, score, pct, color, visible }: SubpilarTooltipProps) {
  ...
  return (
    <div
      className="absolute z-50 right-0 top-full mt-2 w-72 rounded-xl p-4 shadow-2xl pointer-events-none"
      style={{
...
function DrilldownModal({ data, onClose }: { data: DrilldownData; onClose: () => void }) {
  const trendColor =
    data.trend === 'up' ? '#34D399' : data.trend === 'down' ? '#F87171' : '#94A3B8';
  const TrendIcon =
    data.trend === 'up' ? ArrowUpRight : data.trend === 'down' ? ArrowDownRight : Activity;
      ...
      >
        <div
          ...
          style={{
            ...
            background: `linear-gradient(135deg, ${data.color || '#1E40AF'}20, transparent)`,
          }}
        >
          <div>
            <p
              className="text-xs font-semibold uppercase tracking-widest mb-1"
              style={{ color: data.color || '#38BDF8' }}
            >
        ...
        <div className="grid grid-cols-3 gap-4 p-6">
          {[
            {
              label: 'QA Score',
              value: data.qa.toFixed(1),
              color: '#38BDF8',
              icon: <Target size={16} />,
            },
            {
              label: 'IEPC Score',
              value: data.iepc.toFixed(1),
              color: '#818CF8',
              icon: <Zap size={16} />,
            },
            {
            ...
            >
              <div className="flex items-center justify-center mb-2" style={{ color: k.color }}>
                {k.icon}
              </div>
        ...
        <div className="px-6 pb-6 space-y-4">
          <div
            ...
            style={{ backgroundColor: `${trendColor}10`, border: `1px solid ${trendColor}30` }}
          >
            ...
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: '#94A3B8' }}>
                Baseado nos últimos ciclos avaliados
              </p>
            </div>
          </div>
          {data.details && (
            ...
            >
              <p className="text-xs font-semibold text-white mb-2 flex items-center gap-2">
                <Info size={12} style={{ color: '#38BDF8' }} /> Síntese Analítica
              </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              {
                label: 'Pontos Fortes',
                value: 'Consistência técnica e aderência ao protocolo',
                color: '#34D399',
              },
              {
                label: 'Oportunidades',
                value: 'Redução de reincidências e melhoria de comunicação',
                color: '#FBBF24',
              },
            ].map((item) => (
              <div
  ...
  return (
    <div className="flex flex-col items-center">
      <svg width="160" height="90" viewBox="0 0 160 90">
        ...
        <text x={cx} y={cy - 8} textAnchor="middle" fill="white" fontSize="15" fontWeight="bold">
          {pct.toFixed(0)}%
        </text>
      </svg>
...
function HeatmapCell({ value, max }: { value: number; max: number }) {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: color, minHeight: 32, minWidth: 40 }}
    >
...
function QAIEPCContent() {
  ...
  const squads = useMemo(
    () => ['all', ...Array.from(new Set(scores.map((s) => s.squad).filter(Boolean))).sort()],
    [scores]
  );
  const coordenadores = useMemo(
    () => ['all', ...Array.from(new Set(scores.map((s) => s.coordenador).filter(Boolean))).sort()],
    [scores]
  );
  const analistas = useMemo(
    () => ['all', ...Array.from(new Set(scores.map((s) => s.analista).filter(Boolean))).sort()],
    [scores]
  );
  ...
  const conformidade =
    filtered.length > 0
      ? (filtered.filter((s) => s.nota_final_qa >= 70).length / filtered.length) * 100
      : 0;
  ...
  const squadRanking = useMemo(() => {
    ...
    filteredNCs.forEach((n) => {
      if (map[n.squad]) map[n.squad].ncs++;
    });
  ...
  const analystRanking = useMemo(() => {
    const map: Record<
      string,
      { name: string; squad: string; qa: number[]; iepc: number[]; ncs: number }
    > = {};
    filtered.forEach((s) => {
      if (!map[s.analista])
        map[s.analista] = { name: s.analista, squad: s.squad, qa: [], iepc: [], ncs: 0 };
      map[s.analista].qa.push(s.nota_final_qa);
      map[s.analista].iepc.push(s.iepc_total);
    });
    filteredNCs.forEach((n) => {
      if (map[n.analista]) map[n.analista].ncs++;
    });
    return Object.values(map)
      .map((a) => ({
        ...a,
  ...
  const trendData = useMemo(() => {
    ...
    ncs.forEach((n) => {
      if (map[n.periodo]) map[n.periodo].ncs++;
    });
  ...
  const ncByPilar = useMemo(() => {
    ...
    filteredNCs.forEach((n) => {
      map[n.tipo_nc] = (map[n.tipo_nc] || 0) + 1;
    });
    return Object.entries(map)
  ...
  const openDrilldown = (
    ...
    const trend =
      trendData.length >= 2
        ? trendData[trendData.length - 1].qaPct > trendData[trendData.length - 2].qaPct
          ? 'up' :'down' :'stable';
    setDrilldown({
      type,
      label,
      ...
      trend,
      color,
      details: `Análise detalhada de ${label}: QA de ${qa.toFixed(1)} pts (${safePct(qa, QA_TOTAL_MAX).toFixed(0)}%), IEPC de ${iepc.toFixed(1)} pts (${safePct(iepc, IEPC_TOTAL_MAX).toFixed(0)}%) e ${ncs} não conformidades registradas no período selecionado.`,
    });
  };
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm" style={{ color: '#64748B' }}>
            Visão analítica completa de qualidade operacional — Matriz Oficial QA/IEPC
          </p>
        </div>
        <button
          onClick={loadData}
          className="p-2 rounded-lg transition-colors hover:bg-white/5"
          style={{ color: '#94A3B8', border: BORDER }}
        >
          <RefreshCw size={14} />
        </button>
      </div>
      ...
      <div className="rounded-xl p-4" style={{ backgroundColor: CARD_BG, border: BORDER }}>
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs" style={{ color: '#64748B' }}>
            — sincronizados em todos os painéis
          </span>
        </div>
          ...
          {[
            {
              ...
              options: periodos.map((p) => ({ v: p, l: p })),
            },
            {
              label: 'Squad',
              value: filterSquad,
              onChange: setFilterSquad,
              options: squads.filter((s) => s !== 'all').map((s) => ({ v: s, l: s })),
            },
            {
              label: 'Coordenador',
              value: filterCoordenador,
              onChange: setFilterCoordenador,
              options: coordenadores.filter((c) => c !== 'all').map((c) => ({ v: c, l: c })),
            },
            {
              label: 'Analista',
              value: filterAnalista,
              onChange: setFilterAnalista,
              options: analistas.filter((a) => a !== 'all').map((a) => ({ v: a, l: a })),
            },
          ].map((f) => (
            <select
              key={f.label}
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3">
            {[
              {
                label: 'QA Médio',
                value: `${qaPct.toFixed(0)}%`,
                sub: `${qaMedia.toFixed(1)} / ${QA_TOTAL_MAX} pts`,
                color: '#3B82F6',
                icon: <Target size={15} />,
              ...
              {
                label: 'IEPC Médio',
                value: `${iepcPct.toFixed(0)}%`,
                sub: `${iepcMedia.toFixed(1)} / ${IEPC_TOTAL_MAX} pts`,
                color: '#A855F7',
                icon: <Zap size={15} />,
              ...
              {
                label: 'Melhor Pilar',
                value: bestPilar?.label || '—',
                sub: `${bestPilar?.pct.toFixed(0) || '—'}% do máximo`,
                color: '#F59E0B',
                icon: <Star size={15} />,
              ...
              {
                label: 'Pilar Crítico',
                value: worstPilar?.label || '—',
                sub: `${worstPilar?.pct.toFixed(0) || '—'}% do máximo`,
                color: '#F97316',
              ...
              {
                label: 'Melhor Squad',
                value: bestSquad?.squad || '—',
                sub: `QA: ${bestSquad?.qaPct.toFixed(0) || '—'}%`,
                color: '#38BDF8',
                icon: <Users size={15} />,
                glow: 'rgba(56,189,248,0.2)',
              },
              {
                label: 'Analista Destaque',
                value: bestAnalista?.name?.split(' ')[0] || '—',
                sub: `QA: ${bestAnalista?.qaPct.toFixed(0) || '—'}%`,
                color: '#8B5CF6',
                icon: <Award size={15} />,
              ...
              <div
                key={k.label}
                className="rounded-xl p-4 transition-all hover:scale-[1.02] cursor-default"
                style={{
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div
                    ...
                    style={{ backgroundColor: k.glow, color: k.color }}
                  >
                    {k.icon}
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: '#64748B' }}>
                    Radar por Pilares — % do máximo oficial
                  </p>
                </div>
                <div className="flex gap-1">
                  {QA_PILLARS.map((p) => (
                    <div key={p.key} className="group relative">
                      ...
                      <div
                        className="absolute right-0 top-8 z-10 hidden group-hover:block w-64 rounded-xl p-3 text-xs shadow-2xl"
                        style={{ backgroundColor: '#1E293B', border: `1px solid ${p.color}30` }}
                      >
                    ...
                    content={({ active, payload }) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            backgroundColor: '#1E293B',
                            border: `1px solid ${pillar?.color || '#3B82F6'}40`,
                          }}
                        >
                          <p className="font-bold text-white mb-1">{d?.payload?.subject}</p>
                          <p style={{ color: pillar?.color || '#3B82F6' }}>
                            Aderência: <strong>{Number(d?.value).toFixed(1)}%</strong>
                          </p>
              ...
              <div className="grid grid-cols-5 gap-2 mt-3">
                {pillarAvgs.map((p) => (
                  <button
                    key={p.key}
                    onClick={() =>
                      openDrilldown('pilar', p.fullName, p.value, iepcMedia, totalNC, p.color)
                    }
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: '#64748B' }}>
                    Radar por Dimensões — % do máximo oficial
                  </p>
                </div>
                <div className="flex gap-1">
                  {IEPC_DIMS.map((d) => (
                    <div key={d.key} className="group relative">
                      ...
                      <div
                        className="absolute right-0 top-8 z-10 hidden group-hover:block w-64 rounded-xl p-3 text-xs shadow-2xl"
                        style={{ backgroundColor: '#1E293B', border: `1px solid ${d.color}30` }}
                      >
                    ...
                    content={({ active, payload }) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            backgroundColor: '#1E293B',
                            border: `1px solid ${dim?.color || '#A855F7'}40`,
                          }}
                        >
                          <p className="font-bold text-white mb-1">{d?.payload?.subject}</p>
                          <p style={{ color: dim?.color || '#A855F7' }}>
                            Aderência: <strong>{Number(d?.value).toFixed(1)}%</strong>
                          </p>
              ...
              <div className="grid grid-cols-5 gap-2 mt-3">
                {iepcAvgs.map((d) => (
                  <div
                    ...
                    style={{ backgroundColor: `${d.color}12`, border: `1px solid ${d.color}30` }}
                  >
          ...
          >
            <div className="flex items-center gap-3 p-5" style={{ borderBottom: BORDER }}>
              ...
              <span className="text-xs" style={{ color: '#64748B' }}>
                Passe o mouse para ver critérios • Clique para expandir
              </span>
            </div>
              ...
              {SUBPILARES.map((section) => {
                ...
                return (
                  <div key={section.pilar}>
                    <button
                      onClick={() => setExpandedPillar(isOpen ? null : section.pilar)}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                          <p className="text-sm font-semibold text-white">
                            {QA_PILLARS.find((p) => p.key === section.pillarKey)?.fullName}
                          </p>
                          <p className="text-xs mt-0.5" style={{ color: '#64748B' }}>
                            {section.items.length} subpilares · Máx: {section.pillarMax} pts
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <p className="text-sm font-bold" style={{ color: section.color }}>
                            {pillarScore.toFixed(1)} / {section.pillarMax}
                          </p>
                          <p
                    ...
                    {isOpen && (
                      ...
                      >
                        {section.items.map((item) => {
                          ...
                          const barColor =
                            pct >= 80 ? '#10B981' : pct >= 60 ? '#F59E0B' : '#F87171';
                          const glowColor =
                            pct >= 80
                              ? 'rgba(16,185,129,0.5)'
                              : pct >= 60
                          ...
                          return (
                            <div
                              key={item.id}
                              className="relative rounded-xl p-4 transition-all duration-200 hover:bg-white/[0.03]"
                              style={{
                                backgroundColor: 'rgba(255,255,255,0.02)',
                                border: `1px solid rgba(255,255,255,0.05)`,
                              }}
              ...
              <ResponsiveContainer width="100%" height={220}>
                ...
                >
                  ...
                  <Bar
                    ...
                    fill="#3B82F6"
                    radius={[0, 4, 4, 0]}
                    onClick={(d) => openDrilldown('squad', d.squad, d.qa, d.iepc, d.ncs, '#3B82F6')}
          ...
          <div className="rounded-xl p-5" style={{ backgroundColor: CARD_BG, border: BORDER }}>
            <h3 className="text-sm font-bold text-white mb-5">
              Gauges de Performance — Pilares QA (% do máximo oficial)
            </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="rounded-xl p-5" style={{ backgroundColor: CARD_BG, border: BORDER }}>
              <h3 className="text-sm font-bold text-white mb-4">
                Heatmap — Analista × Pilar (% máx)
              </h3>
              <div className="overflow-x-auto">
                <table className="w-full text-xs">
                  <thead>
                    <tr>
                      <th className="text-left pb-2 pr-3" style={{ color: '#64748B' }}>
                        Analista
                      </th>
                      {QA_PILLARS.map((p) => (
                        <th
                  ...
                  <tbody>
                    {heatmapAnalistas.map((a) => {
                      ...
                      return (
                        <tr key={a.name}>
                          <td className="pr-3 py-1 text-white truncate max-w-24">
                            {a.name.split(' ')[0]}
                          </td>
                          {QA_PILLARS.map((p) => {
                            ...
                            return (
                              <td key={p.key} className="px-1 py-1">
                                <HeatmapCell value={rawVal} max={p.max} />
                              </td>
                            );
                          })}
                        </tr>
                    ...
                    {heatmapAnalistas.length === 0 && (
                      <tr>
                        <td colSpan={6} className="py-8 text-center" style={{ color: '#64748B' }}>
                          Sem dados
                        </td>
                      </tr>
                    )}
            ...
            <div className="rounded-xl p-5" style={{ backgroundColor: CARD_BG, border: BORDER }}>
              <h3 className="text-sm font-bold text-white mb-4">
                Scatter — QA% vs IEPC% por Analista
              </h3>
              <ResponsiveContainer width="100%" height={220}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                {analystRanking.slice(0, 8).map((a, i) => (
                  <button
                    key={a.name}
                    onClick={() =>
                      openDrilldown('analista', a.name, a.qa, a.iepc, a.ncs, '#8B5CF6')
                    }
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 text-left">
                      ...
                      <p className="text-xs" style={{ color: '#64748B', fontSize: 10 }}>
                        {a.squad}
                      </p>
                    </div>
            ...
            <div className="rounded-xl p-5" style={{ backgroundColor: CARD_BG, border: BORDER }}>
              <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
                <Users size={14} style={{ color: '#38BDF8' }} /> Ranking Squads
              </h3>
              <div className="space-y-2">
                {squadRanking.slice(0, 8).map((s, i) => (
                  <button
                    key={s.squad}
                    onClick={() => openDrilldown('squad', s.squad, s.qa, s.iepc, s.ncs, '#38BDF8')}
                    className="w-full flex items-center gap-3 py-2 px-2 rounded-lg transition-all hover:bg-white/[0.03]"
                  >
                    <span
                      className="text-xs font-bold w-5 text-center"
                      style={{ color: i === 0 ? '#F59E0B' : i === 1 ? '#94A3B8' : '#475569' }}
                    >
                      #{i + 1}
                    </span>
                    <div className="flex-1 min-w-0 text-left">
                      ...
                      <p className="text-xs" style={{ color: '#64748B', fontSize: 10 }}>
                        IEPC: {safePct(s.iepc, IEPC_TOTAL_MAX).toFixed(0)}%
                      </p>
                    </div>
            ...
            <div className="rounded-xl p-5" style={{ backgroundColor: CARD_BG, border: BORDER }}>
              <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
                <Shield size={14} style={{ color: '#8B5CF6' }} /> Ranking Coordenadores
              </h3>
              <div className="space-y-2">
                {coordRanking.slice(0, 8).map((c, i) => (
                  <button
                    key={c.name}
                    onClick={() => openDrilldown('coordenador', c.name, c.qa, c.iepc, 0, '#8B5CF6')}
                    className="w-full flex items-center gap-3 py-2 px-2 rounded-lg transition-all hover:bg-white/[0.03]"
                  >
                    <span
                      className="text-xs font-bold w-5 text-center"
                      style={{ color: i === 0 ? '#F59E0B' : '#475569' }}
                    >
                      #{i + 1}
                    </span>
                    <div className="flex-1 min-w-0 text-left">
                      ...
                      <p className="text-xs" style={{ color: '#64748B', fontSize: 10 }}>
                        IEPC: {safePct(c.iepc, IEPC_TOTAL_MAX).toFixed(0)}%
                      </p>
                    </div>
