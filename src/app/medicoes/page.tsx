...
import { Calendar, Filter, ChevronRight, Activity, RefreshCw, Search,  } from 'lucide-react';
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded text-[11px] font-bold ${
                            eq.status === 'conforme'
                              ...
                              : eq.status === 'alerta' ?'bg-amber-50 text-amber-700 border border-amber-200' :'bg-red-50 text-red-700 border border-red-200'
                          }`}
                        >
