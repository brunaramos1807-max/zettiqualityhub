...
type Tab =
  | 'usuarios' |'cargos' |'permissoes' |'usuario_permissoes' |'escopos' |'acoes' |'logs' |'auditoria';
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="space-y-1 text-xs" style={{ color: '#94A3B8' }}>
                  <p>
                    <strong className="text-white">Coordenador:</strong> recomendado "Apenas squadsvinculadas"
                  </p>
                  <p>
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              <h2 className="text-base font-bold text-white">
                {activeTab === 'usuario_permissoes' ?'Permissões por Usuário' :'Permissões por Tela/Módulo'}
              </h2>
              <p className="text-xs mt-0.5" style={{ color: '#64748B' }}>
                {activeTab === 'usuario_permissoes' ?'Exceções individuais persistidas em user_permissions' :'Matriz visual de módulos, telas e ações configuráveis'}
              </p>
            </div>
            <div className="relative">
              <Search
